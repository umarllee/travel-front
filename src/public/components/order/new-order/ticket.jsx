...
export const Ticket = forwardRef(function (props, ref) {
        ...
        <div className="pt-2" style={{ borderRadius: ' 10px' }} >
            <div className='row m-0 pt-2 mt-4'>
                ...
                <div className="col-lg-2 d-flex justify-content-center">
                    <span className="change-dest-btn">
                        <svg onClick={handleConsole} xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-arrow-left-right" viewBox="0 0 16 16">
